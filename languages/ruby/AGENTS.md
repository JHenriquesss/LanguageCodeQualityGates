# Agent instructions — Ruby quality gate

When you implement or review Ruby code in a project that uses this gate, follow this. Front-load
...
- Open a specific section of `REFERENCE.md` only when a check trips or its topic is in scope
  (metaprogramming, concurrency, serialization, persistence, security, gems/supply chain).
